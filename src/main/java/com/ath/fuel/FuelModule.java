...
public abstract class FuelModule {
     ...
     * Default Configurations (Override here)
     *   LayoutInflater
     * Automatically handed by FuelInjector (not overridable)
     *   Context -- Will attempt to inject Activity but will fall back on Application.
     *   Activity -- Will only inject Activity, unlike Context
     *   Application -- Will only inject Application, unlike Context
     * </pre>
     */
    ...
    /**
     * Forever bind this class to this instance -- causes strong reference to instance forever
     *
     * @param from
     * @param to
     */
